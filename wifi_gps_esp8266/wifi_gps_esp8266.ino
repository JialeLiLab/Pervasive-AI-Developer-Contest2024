...
const char* ssid = "Smart Modem 2-P2DSLZ67N";//WiFi name
const char* password =  "25JollyRavenM%";//wifi pwd
const char* googleApiKey = "AIzaSyDpzzwxObtRdwbM7MZFcneWZSubN3T_SrE";
